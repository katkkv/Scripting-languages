//ERROR#1 document.getElementById('nav').onmouseover = function(event){
...
function closeMenu(){
	...
	//ERROR#3 var subm = document.getElementsByClassName('submenu');
	var subm = menu.getElementsByClassName('submenu');
